...
class PaymentMethodScreen extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: _buildPaymentOptions(context, ref, selectedMethod),
          ),
          
          // Continue button
          _buildContinueButton(context, ref, selectedMethod),
        ],
      ),
    );
  }
  ...
  Widget _buildPaymentOptions(BuildContext context, WidgetRef ref, PaymentMethod? selectedMethod) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildPaymentOption(
            ...
            icon: 'assets/images/icons/Payment_Methods/Wallet.svg',
          ...
          _buildPaymentOption(
            ...
            icon: 'assets/images/icons/Payment_Methods/Cash.svg',
          ...
          _buildPaymentOption(
            ...
            icon: 'assets/images/icons/Payment_Methods/Add_Card.svg',
  ...
  Widget _buildContinueButton(BuildContext context, WidgetRef ref, PaymentMethod? selectedMethod) {
    ...
    return Container(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          onPressed: canProceed ? () => _onContinuePressed(context, ref, selectedMethod) : null,
          style: ElevatedButton.styleFrom(
            backgroundColor: canProceed ? const Color(0xFFFFFBF1) : const Color(0xFF4D4E52),
            foregroundColor: canProceed ? const Color(0xFF242424) : const Color(0xFF9C9C9D),
            ...
            children: [
              ...
              SvgPicture.asset(
                ...
                colorFilter: ColorFilter.mode(
                  canProceed ? const Color(0xFF242424) : const Color(0xFF9C9C9D),
                  BlendMode.srcIn,
                ),
              ),
  ...
  void _onPaymentMethodSelected(BuildContext context, WidgetRef ref, PaymentMethod method) {
    // For wallet payment, navigate immediately to wallet selection screen
    if (method == PaymentMethod.wallet) {
      try {
        context.push('/checkout/wallet-selection', extra: {
          'total': total,
          'currency': currency,
        });
      } catch (e) {
  ...
  void _onContinuePressed(BuildContext context, WidgetRef ref, PaymentMethod? method) {
    ...
    try {
      ...
      if (paymentMethodEntity != null) {
        ref.read(checkoutProvider.notifier).selectPaymentMethod(paymentMethodEntity);
      }
    ...
    switch (method) {
      ...
      case PaymentMethod.cashOnPickup:
        return const PaymentMethodEntity(
          ...
          iconPath: 'assets/images/icons/Payment_Methods/Cash.svg',
        );
